...
if 'community_data' not in st.session_state:
    if (DATA_DIR / 'community_data.json').exists():
        with open(DATA_DIR / 'community_data.json', 'r', encoding='utf-8') as f:
...
def save_community_data():
    ...
    with open(DATA_DIR / 'community_data.json', 'w', encoding='utf-8') as f:
