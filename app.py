...
from user_data import UserProfile, load_user_data, save_user_data, register_user, validate_login, is_valid_username, is_valid_password, is_valid_phone
...
def get_user_data_file():
    ...
    return f'data/user_{username}.json'
    ...
    if submit:
        if not api_key:
            ...
            with st.spinner("AI正在思考中..."):
                answer = ai_answer(question_text, uploaded_image, 
